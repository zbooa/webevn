...
echo "	1 1.0.15
	...
	6 1.10.3
	7 1.12.2"
read -p "   Please Input 1,2,3,4,5,6,7: " NGI_ID
...
[ $MYS_ID == 1 ] && MYS_VER="5.5.58"
[ $MYS_ID == 2 ] && MYS_VER="5.6.38"
echo
...
[ $PHP_ID == 4 ] && PHP_VER="5.6.31"
[ $PHP_ID == 5 ] && PHP_VER="7.1.10" && P7=1
fi
